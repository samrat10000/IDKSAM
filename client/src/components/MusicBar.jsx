...
const MusicBar = ({ isLivingNight, isOpen, setIsOpen }) => {
    ...
    // Playlist - All 10 songs with correct naming: Artist – Title
    const PLAYLISTS = {
        vibes: [
    ...
    // Ambient loop URLs - Nature sounds
    const AMBIENT_FILES = {
    ...
    const initVisualizer = () => {
        ...
        analyzer.fftSize = 64; // Small fft for chunky 8-bar look
        ...
        Object.keys(ambient).forEach(key => {
            ...
            if (audio) {
                if (ambient[key]) {
                    ...
                    audio.pause();
                    audio.currentTime = 0; // Reset when stopped
                }
            }
        });
    }, [ambient]);

    // Volume sync for ambient with individual volumes
    useEffect(() => {
    ...
    useEffect(() => {
        if (audioRef.current) {
            ...
            // Slow down music during Living Night
            audioRef.current.playbackRate = isLivingNight ? 0.85 : 1.0;
        }
    }, [volume, isLivingNight]);
    ...
    // Full music bar / Cassette Player
    return (
        <div className={`music-drawer-container ${isOpen ? 'open' : ''}`}>
            <div className="music-drawer-content">
                ...
                <div className="cassette-deck vertical">
                    <div className="deck-header">
                        ...
                        <button onClick={() => setIsOpen(false)} className="deck-btn-hide" title="Close">×</button>
                    </div>

                    <div className="cassette-body">
                        {/* Retro Indie Textures */}
                    ...
                    <div className="deck-controls vertical">
                        ...
                        <div className="ambient-mixer vertical">
                            {/* Main Music Volume - Horizontal with Minimal Icon */}
